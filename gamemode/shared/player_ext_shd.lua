...
function plymeta:ObjSetPlaydeadPrimed(state)
    self:SetNWEntity("objPlaydeadPrimed", state)
end

function plymeta:ObjIsPlaydeadPrimed()
    return self:GetNWEntity("objPlaydeadPrimed", false)
end
